...
from Inpainting.utils import create_placeholder, refresh_node
...
def write_ply(
    ...
    if config["save_ply"] is True:
        ...
        try:
            ...
            print(f'Error in writing ply file: {e}')
            exit(1)
    ...
    try:
        ...
        print(f'Error in processing ply : {e}')
